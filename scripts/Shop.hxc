...
class Shop extends MusicBeatState
{
    ...
    override public function create():Void
    {
        ...
        if (!PointlessPins.hasObtainedPin("tuntematon") && PointlessPins.getUnlockedPinsCount() >= 30 && FlxG.random.bool(1) && !Tuntematon.gone && !Ophelia.caught)
        {
            var t:Tuntematon = new Tuntematon(1350 - spriteNudge + shelf.width, 80);
            t.zIndex = -979;
